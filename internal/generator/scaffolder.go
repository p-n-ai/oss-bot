...
type ScaffoldRequest struct {
	...
	Country string
	// GlobalSchemaDir is the path to the global schema directory ({repoPath}/schema/).
	// When set, ScaffoldSubject copies the 6 default schema files into {subjectID}/schemas/.
